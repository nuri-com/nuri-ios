---
title: Set Allowed Wallet Currencies
source_url: https://docs.striga.com/reference/set-allowed-wallet-currencies
scraped_at: 2025-07-18 17:56:04
---

# Set Allowed Wallet Currencies
...
patch https://www.sandbox.striga.com/api/v1/hosted-card/set-allowed-wallet-currencies

Set the list of currencies you would like to allow the card to be linked to within the hosted card widget
