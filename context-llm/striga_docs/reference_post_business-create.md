...
source_url: https://docs.striga.com/reference/post_business-create
scraped_at: 2025-07-18 17:50:11
---
...
post https://www.sandbox.striga.com/api/v1/wallets/business/create

Create a multi-currency wallet for your business. Please note that by default as soon as your business passes KYB, a default wallet is provisioned for your business already. A wallet contains accounts denominated in the currencies enabled for your application. Each account can be further enriched with deposit credentials or linked to payment cards.
