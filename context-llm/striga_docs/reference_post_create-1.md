...
source_url: https://docs.striga.com/reference/post_create-1
scraped_at: 2025-07-18 17:52:33
---
...
post https://www.sandbox.striga.com/api/v1/business/create

A business is a legal entity where one primary user is named upon creation that will act on behalf of the business.
