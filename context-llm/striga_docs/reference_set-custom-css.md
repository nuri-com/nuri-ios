...
source_url: https://docs.striga.com/reference/set-custom-css
scraped_at: 2025-07-18 17:54:01
---
...
post https://www.sandbox.striga.com/api/v1/hosted-card/set-custom-css

This API allows you to define custom CSS styles for your hosted card interface, specifically for fonts and colors. It helps you align the appearance of the cards with your brand guidelines. The styles will be applied across all hosted card screens.
