---
title: Building on Striga - Money movement APIs
source_url: https://docs.striga.com/
scraped_at: 2025-07-18 17:50:33
---

# Building on Striga - Money movement APIs

# Crypto, Banking & Payment APIs

Striga is a platform for businesses to embed compliant payment workflows that involve one or more of custody, trading, banking and issuing. The image below sums up what the platform is all about and what it's core components are.

For instance, with Striga, customers have built on/off ramps, exchange applications, stablecoin backed card products, remittance applications and non-custodial debit cards.
...
[Striga is the first company to be licensed](https://fiu.ee/en/news/striga-technology-ou-was-licensed-virtual-asset-service-provider) to operate under the new law (MiCA like) across Europe and is backed by YCombinator, Berkeley SkyDeck, Charlie Lee (Litecoin), Juan Benet (IPFS) and several others.

![](https://files.readme.io/a4a137b-Clean.PNG)
...
Write to us on [[email protected]](/cdn-cgi/l/email-protection#31424441415e4345714245435856501f525e5c) for any technical assistance.

![](https://files.readme.io/761aac7-cards.gif)
